...
export type { HRState, Employee, AlertMessage as HRAlertMessage } from './hr/types';
export type { Bill, BillsState, AlertMessage as BillsAlertMessage } from './bills/types';
export type { AlertMessage as AccountingAlertMessage } from './accounting/types';
export type { Vendor, VendorMetrics, AlertMessage as VendorsAlertMessage } from './vendors/types';
