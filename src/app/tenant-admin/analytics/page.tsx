          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg p-6 border border-blue-200">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-blue-900">Financial Reports</h3>
              </div>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between text-sm">
                  ...
                  <span className="font-medium text-blue-900">$425K</span>
                </div>
                <div className="flex items-center justify-between text-sm">
                  <span className="text-blue-600">Expense Tracking</span>
                  <span className="font-medium text-blue-900">$326K</span>
                </div>
                <div className="flex items-center justify-between text-sm">
                  <span className="text-blue-600">Profit Margin</span>
                  <span className="font-medium text-blue-900">23.4%</span>
                </div>
              </div>
              <Link
                href="/tenant-admin/analytics/financial"
