...
export default function LifecycleWorkflows({ tenantSlug }: { tenantSlug?: string | null }) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-3xl border border-slate-100 bg-white p-6 shadow-sm">
        <div className="flex items-start justify-between">
          <div className="flex-1">
            ...
            <h2 className="text-lg font-semibold text-slate-900">Workflow Analytics</h2>
            ...
            <div className="rounded-lg border border-slate-200 p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-slate-900">{workflowAnalytics.totalWorkflows}</p>
                </div>
            ...
            <div className="rounded-lg border border-slate-200 p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-slate-900">{workflowAnalytics.activeWorkflows}</p>
                </div>
            ...
            <div className="rounded-lg border border-slate-200 p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-slate-900">{workflowAnalytics.totalExecutions}</p>
                </div>
            ...
            <div className="rounded-lg border border-slate-200 p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-slate-900">{workflowAnalytics.averageSuccessRate.toFixed(1)}%</p>
                </div>
        ...
        {showAnalytics && (
          <div className="mt-6">
            <h3 className="text-md font-semibold text-slate-900 mb-3">Recent Executions</h3>
              ...
              {workflowAnalytics.recentExecutions.map((execution, index) => (
                <div key={index} className="flex items-center justify-between p-3 bg-slate-50 rounded-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-medium text-slate-900">{execution.workflow}</p>
      ...
      {showTemplates && (
        <div className="rounded-3xl border border-slate-100 bg-white p-6 shadow-sm">
          <h3 className="text-lg font-semibold text-slate-900 mb-4">Workflow Templates</h3>
      ...
      <div className="rounded-3xl border border-slate-100 bg-white p-6 shadow-sm">
        <div className="flex items-center justify-between">
          <div>
            ...
            <h2 className="text-xl font-semibold text-slate-900">Create Workflow</h2>
                  ...
                  <div>
                    ...
                    <div className="mt-3 grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                      <div>
                        ...
                        <p className="font-medium text-slate-900">{wf.steps.length} steps</p>
                      </div>
                      <div>
                        <p className="text-slate-600">Executions</p>
                        <p className="font-medium text-slate-900">{wf.executionCount || 0}</p>
                      </div>
                      <div>
                        <p className="text-slate-600">Success Rate</p>
                        <p className="font-medium text-slate-900">{wf.successRate || 0}%</p>
                      </div>
                    </div>
