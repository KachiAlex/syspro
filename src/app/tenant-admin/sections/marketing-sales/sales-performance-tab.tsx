            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-gray-200">
                  ...
                  <th className="text-right py-2 px-3 font-medium text-gray-700">Deals</th>
                  <th className="text-right py-2 px-3 font-medium text-gray-700">Revenue</th>
                  <th className="text-right py-2 px-3 font-medium text-gray-700">Quota</th>
                  <th className="text-right py-2 px-3 font-medium text-gray-700">% to Quota</th>
                </tr>
              </thead>
              <tbody>
