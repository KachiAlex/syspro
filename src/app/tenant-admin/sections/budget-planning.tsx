...
export default function BudgetPlanningWorkspace({
  ...
  async function fetchBudgetDetails() {
    ...
    try {
      ...
      setBudgetLines(linesData.variances || []);
    ...
    try {
      const response = await fetch(
        `/api/finance/budgets/${selectedBudget.id}/variances?tenantSlug=${tenantSlug}`,
        {
          ...
          body: JSON.stringify({
            varianceId,
            acknowledgedBy: currentUser?.id || "unknown",
          }),
        }
      );
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="bg-white w-full border border-gray-300 rounded-lg px-3 py-2 pl-7 text-sm"
                    />
                  </div>
                </div>
                <div>
                  ...
                  <div className="flex gap-3">
                    <div className="flex-1">
                      <input
                        ...
                        className="bg-white w-full border border-gray-300 rounded px-2 py-1 text-sm"
                      />
                    </div>
                    <button
