      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="rounded-lg border border-blue-200 bg-blue-50 p-4">
            ...
            <div className="space-y-2">
              {inProgressTasks.map(task => (
                <div key={task.id} className="rounded-lg border border-blue-200 bg-white p-3 hover:shadow-md transition">
                  <div className="flex items-start justify-between gap-2 mb-2">
                    <p className="text-sm font-medium text-gray-900 flex-1">{task.title}</p>
                    <button
                      onClick={() => handleDeleteTask(task.id)}
                  ...
                  <div className="flex gap-1">
                    <button
                      ...
                      className="flex-1 text-xs px-2 py-1 rounded bg-gray-100 text-gray-700 hover:bg-gray-200 transition"
                    >
                      Back
                    </button>
                    <button
          ...
          <div className="rounded-lg border border-emerald-200 bg-emerald-50 p-4">
            ...
            <div className="space-y-2">
              {doneTasks.map(task => (
                <div key={task.id} className="rounded-lg border border-emerald-200 bg-white p-3 hover:shadow-md transition opacity-75">
                  <div className="flex items-start justify-between gap-2 mb-2">
                  ...
                  <button
                    onClick={() => handleUpdateTaskStatus(task.id, 'in-progress')}
                    className="w-full text-left text-xs px-2 py-1 rounded bg-gray-100 text-gray-700 hover:bg-gray-200 transition"
                  >
                    Reopen
                  </button>
                </div>
