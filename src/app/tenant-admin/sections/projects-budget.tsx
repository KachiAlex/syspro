      ...
      <div className="rounded-lg border border-gray-200 bg-white p-6">
        ...
        <div className="flex gap-2 flex-col md:flex-row">
          ...
          <input
            ...
            className="w-32 rounded-lg border border-gray-300 bg-white px-3 py-2 text-gray-900 placeholder-gray-400 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20 transition"
          />
          <button
