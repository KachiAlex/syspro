    ...
    onSubmit: async (values: WorkflowFormData) => {
      ...
      try {
        ...
        const response = await handleApiCall(() => 
          fetch(`/api/tenant/workflows?tenantSlug=${encodeURIComponent(tenantSlug ?? "kreatix-default")}`, {
            method: "POST",
        ...
        return (
          <div className="space-y-6">
            ...
            <div>
              ...
              <textarea
                className="w-full px-3 py-2 border border-slate-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-vertical"
                rows={3}
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <h4 className="font-medium text-blue-900 mb-2">Workflow Type Information</h4>
        ...
        return (
          <div className="space-y-6">
            <div className="bg-slate-50 border border-slate-200 rounded-lg p-6">
              <h3 className="text-lg font-semibold text-slate-900 mb-4">Review Workflow Configuration</h3>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="mt-2 space-y-2">
                    {steps.map((step, index) => (
                      <div key={index} className="flex items-center gap-4 text-sm bg-white p-2 rounded border">
