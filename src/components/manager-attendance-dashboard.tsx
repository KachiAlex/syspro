      ...
      <div className="rounded-3xl border border-slate-100 bg-white p-6 shadow-sm">
        ...
        <div className="grid gap-4 lg:grid-cols-3">
          ...
          <div className="flex items-end">
            <button className="w-full rounded-lg bg-blue-600 px-4 py-2 text-sm font-semibold text-white shadow-sm transition hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-400">
              Apply Filters
            </button>
          </div>
        </div>
